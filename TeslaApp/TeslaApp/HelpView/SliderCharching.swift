//
//  SliderCharching.swift
//  TeslaApp
//
//  Created by Vakil on 18.05.2024.
//
            ...
            VStack {
                VStack {
                    ZStack(alignment: .leading) {
                        ...
                        CustomCharging()
                            .fill(LinearGradient(gradient: Gradient(colors: [Color.topCh, Color.bottomCh]), startPoint: .top, endPoint: .bottom))
